...
export default function AboutMe() {
  return (
    <div>
      ...
      <ul className="mx-auto max-w-[700px] pt-5 text-gray-500 md:text-lg dark:text-gray-400 text-justify pb-4">
      ...
      <p className="mx-auto max-w-[700px] pt-5 text-gray-500 md:text-lg dark:text-gray-400 text-justify pb-4">I'm currently open to freelance opportunities and creative collaborations. If you're looking for someone who understands both design and code — let’s talk!</p>
    </div>
  )
}
