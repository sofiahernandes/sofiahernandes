    ...
    },
    {
      ...
      colors: [
        ...
        },
        {
          ...
          description: "Text on error elements",
        },
      ],
    },
  ];
      ...
      try {
        ...
        if (imported.colors && imported.name) {
          ...
          toast({
            ...
            description:
              "Theme has been loaded and previewed. You can now customize and save it.",
          });
        }
      } catch {
        toast({
    ...
    >
      ...
      <DialogContent className="max-w-4xl max-h-[90vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create and manage your custom color schemes. Changes are previewed
            in real-time.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="space-y-6 pr-4">
                {colorCategories.map((category) => (
                  <div key={category.name}>
                    ...
                    <div className="grid gap-4 lg:grid-cols-2">
                      {category.colors.map((color) => (
                        <ColorPicker
                          ...
                          value={
                            currentTheme.colors[
                              color.key as keyof typeof currentTheme.colors
                            ]
                          }
                          onChange={(value) =>
                            handleColorChange(
                    ...
                    {category !==
                      colorCategories[colorCategories.length - 1] && (
              ...
              <div className="space-y-4 pr-4">
                {customThemes.length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm">
                      Create your first theme in the "Create Theme" tab.
                    </p>
                  </div>
                ) : (
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Created{" "}
                            {new Date(themeItem.createdAt).toLocaleDateString()}
                          </p>
                        </div>
                        <div className="flex gap-2">
                          <Button
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => handleExportTheme(themeItem)}
                          >
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleDeleteTheme(themeItem.id, themeItem.name)
                            }
                          >
